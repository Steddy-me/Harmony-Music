...
class SettingsScreenController extends GetxController {
  ...
  Future<void> _setInitValue() async {
    ...
    final sharedPath = setBox.get("sharedLocationPath");
    sharedLocationPath.value = sharedPath == null ? "" : sharedPath.toString();
  ...
  Future<void> setSharedLocation() async {
    if (!await PermissionService.getExtStoragePermission()) {
      return;
    }

    final String? pickedFolderPath = await FilePicker.platform
        .getDirectoryPath(dialogTitle: "Select shared folder");
    if (pickedFolderPath == '/' || pickedFolderPath == null) {
      return;
    }

    setBox.put("sharedLocationPath", pickedFolderPath);
    sharedLocationPath.value = pickedFolderPath;
  }
  ...
  void resetSharedLocation() {
    setBox.put("sharedLocationPath", "");
    sharedLocationPath.value = "";
  }
  ...
  Future<void> closeAllDatabases() async {
    debugPrint('closeAllDatabases called');
  }
