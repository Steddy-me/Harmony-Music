...
class AlbumScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    debugPrint('ALBUM SCREEN BUILD ACTIVE');

    final albumController = Get.isRegistered<AlbumScreenController>()
                        ...
                        Expanded(
                          child: Obx(
                            () => Marquee(
                              ...
                              id:
                                  "${albumController.album.value.title.hashCode}_appbar",
                              child: Text(
                                          ...
                                          () => Material(
                                            ...
                                            child: InkWell(
                                              ...
                                              onTap: () async {
                                                ...
                                                debugPrint(
                                                  'ALBUM TAP => title=${currentAlbum.title} | browseId=${currentAlbum.browseId} | add=$add | songs=${albumController.songList.length}',
                                                );
                                                ...
                                                if (currentAlbum.browseId
                                                    .trim()
                                                    .isEmpty) {
                                                  debugPrint(
                                                    'ALBUM TAP ERROR => empty browseId',
                                                  );
                                                  ScaffoldMessenger.of(context)
                                                      .showSnackBar(
                                                    snackbar(
  ...
  Widget buildTitleSubTitle(
    ...
    final artists = albumController.album.value.artists
            ?.map((e) => e['name'])
            .join(", ") ??
        "";
