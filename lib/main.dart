...
Future<void> main() async {
  ...
  await Get.putAsync(
    () async => await SharedLibraryService().init(),
    permanent: true,
  );
  await Get.find<SharedLibraryService>().importAll();
  Get.find<SharedLibraryService>().startAutoSync();
...
Future<void> initHive() async {
  ...
  await Hive.openBox("SharedSongs");
}
